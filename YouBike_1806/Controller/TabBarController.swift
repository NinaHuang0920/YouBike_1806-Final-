...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        navigationController.tabBarItem.image = #imageLiteral(resourceName: "note2")
        ...
        secondnavigationController.tabBarItem.image = #imageLiteral(resourceName: "map3")
        ...
        tabBar.tintColor = navigationTitleColor
        tabBar.unselectedItemTintColor = mainViewBackgroundColor
